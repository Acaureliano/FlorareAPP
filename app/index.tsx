...
const itemsImg = {
  ...
  checkeon: require('./assets/checkon.png'),
  checkeoff: require('./assets/checkoff.png'),
  circulo: require('./assets/icon-circulo.png'),
  abrir: require('./assets/abrir.png'),
};
...
export default function Home () {
  ...
  const handlePressProjeto = (projeto: Projeto) => {
    router.push({ pathname: '/screens/Projeto', params: { projeto: JSON.stringify(projeto) } });
  };
          ...
          {projetos.length === 0 ? (
            ...
            <View style={{ flex: 1 }}>
              ...
              {projetos.map(projeto => (
                <View key={projeto.id} style={{ flex: 1 }}>
                  <TouchableOpacity style={styled.botaolista} onPress={() => handlePressProjeto(projeto)}>
